...
export function World(props) {
  ...
  return (
    <Canvas scene={scene} camera={new PerspectiveCamera(50, aspect, 180, 1800)}>
      <WebGLRendererConfig />
      <ambientLight color={defaultLightConfig.ambientLight} intensity={0.6} />
      <directionalLight
        color={defaultLightConfig.directionalLeftLight}
        position={new Vector3(-400, 100, 400)}
      />
      <directionalLight
        color={defaultLightConfig.directionalTopLight}
        position={new Vector3(-200, 500, 200)}
      />
      <pointLight
        color={defaultLightConfig.pointLight}
        position={new Vector3(-200, 500, 200)}
        intensity={0.8}
      />
      <Globe {...props} data={sampleArcs} />
      <OrbitControls
        enablePan={false}
        enableZoom={false}
        minDistance={cameraZ}
